...
export const LIFE_SECTIONS: LifeSection[] = [
  ...
  { title: "Sports", description: "Sports I follow and play.", href: "/sports", icon: "bi-trophy" },
  ...
  { title: "Photography", description: "Photos I take.", href: "/photography", icon: "bi-camera" },
];